  ...
  return (
    ...
    >
      ...
      <Header
        ...
        description={"Choose the muscles you're ready to crush and transform"}
      />
      ...
      <Header
        index={"03"}
        title={"Transform into a powerhouse"}
        ...
        {Object.keys(SCHEMES).map((scheme, schemeIndex) => {
          return (
            <button
              ...
              className={`bg-slate-950 border px-4 border-blue-400 py-3 rounded-lg duration-200 hover:border-blue-600
